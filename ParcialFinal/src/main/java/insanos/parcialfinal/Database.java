...
public class Database { //00191223 // Declaracion de la clase que conectara la base de datos,
    private static final String URL = "jdbc:mysql://localhost:3306/dbBancoNlogonia"; //00191223 URL de la base de datos
    private static final String USER = "root"; //00191223el usuario de la base de datos.
    private static final String PASSWORD = "1234"; //00191223 contraseña del usuario de la base de datos.
