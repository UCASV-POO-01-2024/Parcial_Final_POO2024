...
public class ReporteDController {
    ...
    private List<ClienteCompraInfo> CrearReporteD() throws IOException {
        List<ClienteCompraInfo> clientesInfo = new ArrayList<>(); // 00087023 Lista para almacenar la información de los clientes.
        ...
        String query = "SELECT c.nombre, COUNT(t.id) AS cantidad_compras, SUM(t.precio) AS total_gastado " +
                ...
                "GROUP BY c.nombre"; // 00087023 Consulta SQL para obtener la información de los clientes que han utilizado tarjetas de un facilitador específico.
        ...
        try (Connection conn = Database.getConnection();
            ...
            while (rs.next()) {
                ...
                clientesInfo.add(new ClienteCompraInfo(nombreCliente, cantidadCompras, totalGastado)); // 00087023 Añade la información del cliente a la lista.
            }
    ...
    private void MostrarReporteD() throws IOException {
        List<ClienteCompraInfo> clientesInfo = CrearReporteD(); // 00087023 Crea el reporte obteniendo la información de los clientes.
        guardarInformeEnArchivo(clientesInfo); // 00087023 Guarda el informe en un archivo.
    }

    private void guardarInformeEnArchivo(List<ClienteCompraInfo> clientesInfo) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(archivo))) {
            ...
            for (ClienteCompraInfo info : clientesInfo) {
    ...
    public void setSistema(Sistema sistema) {
        this.sistema = sistema; // 00087023 Establece la referencia al sistema.
    }
}

class ClienteCompraInfo {
    private String nombreCliente; // 00087023 Variable para almacenar el nombre del cliente.
    private int cantidadCompras; // 00087023 Variable para almacenar la cantidad de compras realizadas por el cliente.
    private BigDecimal totalGastado; // 00087023 Variable para almacenar el total de dinero gastado por el cliente.
